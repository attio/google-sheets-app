    ...
    return (
        <>
            ...
            <CheckboxInput
                ...
                help="Row 1 is treated as column names and is never overwritten. Turn this off if your sheet starts straight into data, and reference columns by letter."
                disableVariables
            />
            <ComboboxInput
                name="mode"
                ...
                options={[
                    ...
                    {label: "Prepend (insert as the first data row)", value: "prepend"},
                ]}
            />
            <CollectionInput
                name="columns"
